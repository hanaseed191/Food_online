...
<div class="card shadow p-5 mb-5 bg-body rounded">
            ...
            if (isset($_SESSION['status'])) {
                if ($_SESSION['status'] === 'success') {
                    ...
                    echo '<div class="alert alert-primary" align="left" role="alert"><b>Order Cancelled!</b></div>';
                }
                    ...
                    <tbody class="text-center">
                        <form action="config_order.php" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-<?php echo $result['order_id']; ?>">
                                    Detail
                                </button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="modal-<?php echo $result['order_id']; ?>" tabindex="-1" aria-labelledby="modalLabel-<?php echo $result['order_id']; ?>" aria-hidden="true">
